...
import (
	...
	"github.com/andrew-plunk/retry/backoff"
	"github.com/andrew-plunk/retry/jitter"
)
...
func Debug(logger logrus.FieldLogger) Strategy {
	return func(attempt uint, err error) bool {
		logger.Debugf("Err:%v Attempt:%d", err, attempt)
		return true
	}
}
